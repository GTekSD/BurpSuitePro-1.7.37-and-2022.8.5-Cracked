...
**4.2. Use BurpSuit**
```
java --illegal-access=permit -Dfile.encoding=utf-8 -javaagent:"C:\Program Files\BurpSuitePro\loader.jar" 
-noverify -jar "C:\Program Files\BurpSuitePro\burpsuite_pro.jar"
```
